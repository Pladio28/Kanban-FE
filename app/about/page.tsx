    ...
    <main className="min-h-screen text-white pt-24">
      ...
      <section className="py-24 px-6 md:px-20 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          >
            {isSignedIn ? "Buka Project" : "Coba Sekarang"}
          </Button>
        </div>
      </section>
      ...
      <section className="py-24 px-6 md:px-20">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-semibold text-center mb-10">Visi & Misi</h2>
      ...
      <section className="py-24 px-6 md:px-20">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-semibold text-center mb-12">Tim Pengembang</h2>

          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { name: "Pladio.M", role: "Frontend Developer" },
              { name: "Abdlillah", role: "Backend Engineer" },
            ].map((member, i) => (
              <Card
                key={i}
      ...
      <section className="py-24 px-6 md:px-20 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-semibold mb-6">Teknologi yang Digunakan</h2>
      ...
      <section className="py-24 px-6 md:px-20 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          >
            {isSignedIn ? "Buka Project" : "Mulai Sekarang"}
          </Button>
        </div>
      </section>
